let tagObject = function () {
    ...
    this.editItem = function (e) {
        ...
        this.createModal('Редактировать тег', {attr_id: target.data("id")});
    };

    this.addItem = function (e) {
        let target = $(e.currentTarget);
        this.createModal('Добавить тег')
    };
...
function submitForm(e) {
    ...
    $.ajax({
            ...
            .done(function (msg) {
               tagApplication.dialog.modal('hide');
...
let tagApplication = new tagObject();
tagApplication.init();
